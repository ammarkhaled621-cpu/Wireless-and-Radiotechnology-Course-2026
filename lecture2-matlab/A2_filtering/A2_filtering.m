...
%% 6) Case 3: Get ~600 Hz using BPF
bp1 = 550; bp2 = 650;                   
y600 = bandpass(Vin, [bp1 bp2], Fs);
...
%% 7) Case 4: Get ~700 and ~800 Hz using HPF
cutoff = 650;
